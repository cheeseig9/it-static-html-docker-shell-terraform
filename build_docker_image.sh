...
sudo docker build -t it-web-sample-image .
...
sudo docker tag techmax chetseig9/it-web-sample-terraform

# push the image to your docker hub repository
sudo docker push chetseig9/it-web-sample-terraform

# start the container to test the image 
sudo docker run -dp 80:80 chetseig9/it-web-sample-terraform
